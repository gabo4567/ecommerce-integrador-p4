...
const PasswordResetConfirm: React.FC = () => {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("No se pudo confirmar el código");
    }
  };
  ...
  return (
    <Layout>
      <div className="max-w-md mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Confirmar recuperación</h1>
        <form onSubmit={submit} className="space-y-4 bg-white rounded-lg p-6 shadow">
          ...
          <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded">Restablecer contraseña</button>
