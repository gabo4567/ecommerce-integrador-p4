      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex items-center space-x-6">
            ...
            <Link to="/productos" className="text-gray-700 hover:text-blue-600 font-medium">Productos</Link>
            <Link to="/seguimiento" className="text-gray-700 hover:text-blue-600 font-medium">Seguimiento</Link>
            <div className="flex items-center space-x-4">
              {access ? (
                <>
                  ...
                  <button onClick={() => setConfirmLogout(true)} className="text-gray-700 hover:text-blue-600 font-medium">Cerrar sesión</button>
                </>
              ) : (
                <>
                  <Link to="/login" className="text-gray-700 hover:text-blue-600 font-medium">Iniciar sesión</Link>
                  <Link to="/registro" className="text-gray-700 hover:text-blue-600 font-medium">Registrarme</Link>
                </>
              )}
