...
const shipmentTrackingRefresh = onSchedule("every 60 minutes", async () => {
...
module.exports = { shipmentTrackingRefresh, runShipmentTrackingRefresh: shipmentTrackingRefresh };